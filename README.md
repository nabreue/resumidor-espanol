...
El modelo fine-tuned se guardará automáticamente en `model_finetuned/`. La aplicación principal (`app.py`) detectará y usará automáticamente el modelo fine-tuned si existe, de lo contrario usará el modelo base.
...
- Explorar **LoRA / QLoRA** para un fine-tuning más eficient (ya implementado parcialmente)
- Explorar **LoRA / QLoRA** para un fine-tuning más eficiente en GPU con menos memoria
- Implementar métricas **ROUGE** automáticas durante el entrenamientoe en GPU con menos memoria
